...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-e", "--expiration", type=int, help="Enable this if you want uploads to be automatically deleted after a certain time (in seconds, 60-15552000).")
    parser.add_argument("-k", "--key", action="store_true", help="The API key.")
